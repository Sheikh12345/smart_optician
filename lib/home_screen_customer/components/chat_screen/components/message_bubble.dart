            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                    color: AppConstants().primaryColorCustomer, shape: BoxShape.circle),
                child: Text(
                 'S',
                  style: TextStyle(
              ...
              InkWell(
                ...
                child: Hero(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        color: AppConstants().primaryColorCustomer.withOpacity(0.2),
                        borderRadius: const BorderRadius.only(
                            bottomLeft: Radius.circular(18),
                            bottomRight: Radius.circular(18),
                            topRight: Radius.circular(18))),
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: Slider(
                        ...
                        activeColor:AppConstants().primaryColorCustomer,
